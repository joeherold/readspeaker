 ...
 */
$be_readspeaker = array(
    'readspeaker' => array(
        'readspeaker_help'           => array
            (
            'callback'   => 'BE_RS_Help',
            'icon'       => 'system/modules/readspeaker/assets/help.gif',
            'javascript' => array('assets/jquery/core/'. JQUERY .'/jquery.min.js','assets/jquery/colorbox/'.COLORBOX.'/js/colorbox.min.js'),
            'stylesheet' => array('assets/jquery/colorbox/'. COLORBOX .'/css/colorbox.min.css')
        ),
        'readspeaker_customerportal' => array
            (
            'callback' => 'BE_RS_CustomerPortal',
            'icon'     => 'system/modules/readspeaker/assets/portal.gif',
        ),
        'readspeaker_settings'       => array
            (
            'tables' => array('tl_rs_settings'),
            'icon'   => 'system/modules/readspeaker/assets/languages.gif',
        ),
        'readspeaker_contact'        => array
            (
            'callback' => 'BE_RS_Contact',
            'icon'     => 'system/modules/readspeaker/assets/contact.gif',
        ),
    )
);
...
array_insert($GLOBALS['BE_MOD'], 0, $be_readspeaker);
 ...
 */
$readspeaker_content_object = array(
    'readspeaker_content_grp' => array(
        'mod_rs'                => 'FE_ReadSpeaker',
        'mod_rs_skip_from_here' => 'FE_ReadSpeakerSkip',
        'mod_rs_read_from_here' => 'FE_ReadSpeakerRead'
    )
);

array_insert($GLOBALS['FE_MOD'], 0, $readspeaker_content_object);
 ...
 */
$readspeaker_content_object = array(
    'rs_content_grp' => array(
        'rs_content_ce'   => 'CE_ReadSpeaker',
        'rs_content_end'  => 'CE_ReadSpeakerEnd',
        'rs_content_skip' => 'CE_ReadSpeakerSkip',
        'rs_content_read' => 'CE_ReadSpeakerRead',
        'rs_content_doc'  => 'CE_ReadSpeakerDoc'
    )
);

array_insert($GLOBALS['TL_CTE'], 1, $readspeaker_content_object);


/**
 * Wrapper elements
 */
$GLOBALS['TL_WRAPPERS']['start'][] = 'rs_content_ce';
$GLOBALS['TL_WRAPPERS']['stop'][]  = 'rs_content_end';

$GLOBALS['TL_WRAPPERS']['separator'][] = 'rs_content_skip';
$GLOBALS['TL_WRAPPERS']['separator'][] = 'rs_content_read';


//$GLOBALS['TL_WRAPPERS']['single'][] = 'rs_content_skip';
 ...
 */
//$GLOBALS['TL_HOOKS']['parsegeArticles'][] = array('RS_ArticleHook', 'addWrapper');
